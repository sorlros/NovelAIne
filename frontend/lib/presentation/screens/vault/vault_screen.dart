        ...
        children: [
          ...
          Expanded(
            child: charactersAsync.when(
              data: (characters) {
                // Filter: Only show vaulted characters and match search query
                    ...
                    return _VaultCharacterCard(
                      ...
                      onTap: () => showModalBottomSheet(
                        ...
                        builder: (context) => CharacterSheetWidget(
                          // Map CharacterModel back to generic map for existing widget
                          character: {
                            'id': char.id,
                            'name': char.name,
                ...
                Expanded(
                  ...
                  child: char.imageUrl != null
                      ...
                      : Container(
                          ...
                          child: const Icon(Icons.person_rounded, size: 48, color: Colors.white10),
                        ),
                ),
                Expanded(
                  flex: 2,
